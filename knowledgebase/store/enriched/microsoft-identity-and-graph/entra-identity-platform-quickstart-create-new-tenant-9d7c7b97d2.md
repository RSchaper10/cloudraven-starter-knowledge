---
title: Create a Microsoft Entra tenant - Microsoft identity platform | Microsoft Learn | CloudRaven Enrichment
...
# Create a Microsoft Entra tenant - Microsoft identity platform | Microsoft Learn | CloudRaven Enrichment
...
- Extracted page: `knowledgebase/store/extracted/microsoft-identity-and-graph/entra-identity-platform-quickstart-create-new-tenant-9d7c7b97d2.md`
- Raw source: `knowledgebase/store/raw_html/microsoft-identity-and-graph/entra-identity-platform-quickstart-create-new-tenant-9d7c7b97d2.html`
