---
title: Configure desktop apps that call web APIs - Microsoft identity platform | Microsoft Learn | CloudRaven Enrichment
...
# Configure desktop apps that call web APIs - Microsoft identity platform | Microsoft Learn | CloudRaven Enrichment
...
- Extracted page: `knowledgebase/store/extracted/microsoft-identity-and-graph/entra-identity-platform-scenario-desktop-app-configuration-d399e01ff1.md`
- Raw source: `knowledgebase/store/raw_html/microsoft-identity-and-graph/entra-identity-platform-scenario-desktop-app-configuration-d399e01ff1.html`
