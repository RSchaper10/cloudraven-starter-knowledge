---
title: How to configure daemon apps that call web APIs - Microsoft identity platform | Microsoft Learn | CloudRaven Enrichment
...
# How to configure daemon apps that call web APIs - Microsoft identity platform | Microsoft Learn | CloudRaven Enrichment
...
- Extracted page: `knowledgebase/store/extracted/microsoft-identity-and-graph/entra-identity-platform-scenario-daemon-app-configuration-89f97c606a.md`
- Raw source: `knowledgebase/store/raw_html/microsoft-identity-and-graph/entra-identity-platform-scenario-daemon-app-configuration-89f97c606a.html`
