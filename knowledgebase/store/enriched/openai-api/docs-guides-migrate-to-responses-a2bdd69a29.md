---
title: Migrate to the Responses API | OpenAI API | CloudRaven Enrichment
...
# Migrate to the Responses API | OpenAI API | CloudRaven Enrichment
...
- Extracted page: `knowledgebase/store/extracted/openai-api/docs-guides-migrate-to-responses-a2bdd69a29.md`
- Raw source: `knowledgebase/store/raw_html/openai-api/docs-guides-migrate-to-responses-a2bdd69a29.html`
