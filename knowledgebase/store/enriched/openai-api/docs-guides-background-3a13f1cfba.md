---
title: Background mode | OpenAI API | CloudRaven Enrichment
...
# Background mode | OpenAI API | CloudRaven Enrichment
...
- Extracted page: `knowledgebase/store/extracted/openai-api/docs-guides-background-3a13f1cfba.md`
- Raw source: `knowledgebase/store/raw_html/openai-api/docs-guides-background-3a13f1cfba.html`
