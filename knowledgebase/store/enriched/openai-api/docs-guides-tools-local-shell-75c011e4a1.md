---
title: Local shell | OpenAI API | CloudRaven Enrichment
...
# Local shell | OpenAI API | CloudRaven Enrichment
...
- Extracted page: `knowledgebase/store/extracted/openai-api/docs-guides-tools-local-shell-75c011e4a1.md`
- Raw source: `knowledgebase/store/raw_html/openai-api/docs-guides-tools-local-shell-75c011e4a1.html`
