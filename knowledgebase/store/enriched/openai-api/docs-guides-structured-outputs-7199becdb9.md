---
title: Structured model outputs | OpenAI API | CloudRaven Enrichment
...
# Structured model outputs | OpenAI API | CloudRaven Enrichment
...
- Extracted page: `knowledgebase/store/extracted/openai-api/docs-guides-structured-outputs-7199becdb9.md`
- Raw source: `knowledgebase/store/raw_html/openai-api/docs-guides-structured-outputs-7199becdb9.html`
