---
title: Evaluate agent workflows | OpenAI API | CloudRaven Enrichment
source_url: https://developers.openai.com/api/docs/guides/agent-evals
target_id: openai-api
dependency: OpenAI API
collected_at: 2026-04-16T03:20:27.091321+00:00
kind: enriched-doc
tags: openai, llm, responses-api, tools, agentic-doing
---

# Evaluate agent workflows | OpenAI API | CloudRaven Enrichment
...
- Extracted page: `knowledgebase/store/extracted/openai-api/docs-guides-agent-evals-de05df7862.md`
- Raw source: `knowledgebase/store/raw_html/openai-api/docs-guides-agent-evals-de05df7862.html`
