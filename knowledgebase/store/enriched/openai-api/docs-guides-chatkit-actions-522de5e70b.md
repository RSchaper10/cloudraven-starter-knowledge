---
title: Actions in ChatKit | OpenAI API | CloudRaven Enrichment
...
# Actions in ChatKit | OpenAI API | CloudRaven Enrichment
...
- Extracted page: `knowledgebase/store/extracted/openai-api/docs-guides-chatkit-actions-522de5e70b.md`
- Raw source: `knowledgebase/store/raw_html/openai-api/docs-guides-chatkit-actions-522de5e70b.html`
