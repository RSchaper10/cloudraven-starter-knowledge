---
title: WebSocket Mode | OpenAI API | CloudRaven Enrichment
...
# WebSocket Mode | OpenAI API | CloudRaven Enrichment
...
- Extracted page: `knowledgebase/store/extracted/openai-api/docs-guides-websocket-mode-9fa2c63f6e.md`
- Raw source: `knowledgebase/store/raw_html/openai-api/docs-guides-websocket-mode-9fa2c63f6e.html`
