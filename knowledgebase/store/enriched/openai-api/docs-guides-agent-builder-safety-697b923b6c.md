---
title: Safety in building agents | OpenAI API | CloudRaven Enrichment
...
# Safety in building agents | OpenAI API | CloudRaven Enrichment
...
- Extracted page: `knowledgebase/store/extracted/openai-api/docs-guides-agent-builder-safety-697b923b6c.md`
- Raw source: `knowledgebase/store/raw_html/openai-api/docs-guides-agent-builder-safety-697b923b6c.html`
