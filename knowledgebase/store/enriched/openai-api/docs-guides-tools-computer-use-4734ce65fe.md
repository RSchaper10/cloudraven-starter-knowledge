---
title: Computer use | OpenAI API | CloudRaven Enrichment
...
# Computer use | OpenAI API | CloudRaven Enrichment
...
- Extracted page: `knowledgebase/store/extracted/openai-api/docs-guides-tools-computer-use-4734ce65fe.md`
- Raw source: `knowledgebase/store/raw_html/openai-api/docs-guides-tools-computer-use-4734ce65fe.html`
