---
title: Apply Patch | OpenAI API | CloudRaven Enrichment
...
# Apply Patch | OpenAI API | CloudRaven Enrichment
...
- Extracted page: `knowledgebase/store/extracted/openai-api/docs-guides-tools-apply-patch-8844627a84.md`
- Raw source: `knowledgebase/store/raw_html/openai-api/docs-guides-tools-apply-patch-8844627a84.html`
