---
title: Guardrails and human review | OpenAI API | CloudRaven Enrichment
...
# Guardrails and human review | OpenAI API | CloudRaven Enrichment
...
- Extracted page: `knowledgebase/store/extracted/openai-api/guides-agents-guardrails-approvals-d763e3d3c1.md`
- Raw source: `knowledgebase/store/raw_html/openai-api/guides-agents-guardrails-approvals-d763e3d3c1.html`
