---
title: Method: users.labels.create | Gmail | Google for Developers | CloudRaven Enrichment
source_url: https://developers.google.com/workspace/gmail/api/reference/rest/v1/users.labels/create
target_id: google-identity-and-workspace
dependency: Google Identity and Workspace Events
collected_at: 2026-04-16T03:21:16.952647+00:00
kind: enriched-doc
tags: google, auth, gmail, calendar, webhooks, notifications
---

# Method: users.labels.create | Gmail | Google for Developers | CloudRaven Enrichment
...
- HTTP request POST https://gmail.googleapis.com/gmail/v1/users/{userId}/labels The URL uses gRPC Transcoding syntax.
...
- Extracted page: `knowledgebase/store/extracted/google-identity-and-workspace/v1-users-labels-create-73a39f4b69.md`
- Raw source: `knowledgebase/store/raw_html/google-identity-and-workspace/v1-users-labels-create-73a39f4b69.html`
