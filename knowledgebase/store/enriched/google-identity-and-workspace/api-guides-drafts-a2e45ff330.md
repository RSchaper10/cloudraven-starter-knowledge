---
title: Create and send draft emails | Gmail | Google for Developers | CloudRaven Enrichment
...
# Create and send draft emails | Gmail | Google for Developers | CloudRaven Enrichment
...
- Extracted page: `knowledgebase/store/extracted/google-identity-and-workspace/api-guides-drafts-a2e45ff330.md`
- Raw source: `knowledgebase/store/raw_html/google-identity-and-workspace/api-guides-drafts-a2e45ff330.html`
