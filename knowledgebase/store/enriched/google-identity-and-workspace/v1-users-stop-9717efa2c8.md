---
title: Method: users.stop | Gmail | Google for Developers | CloudRaven Enrichment
source_url: https://developers.google.com/workspace/gmail/api/reference/rest/v1/users/stop
target_id: google-identity-and-workspace
dependency: Google Identity and Workspace Events
collected_at: 2026-04-16T03:20:59.997906+00:00
kind: enriched-doc
tags: google, auth, gmail, calendar, webhooks, notifications
---

# Method: users.stop | Gmail | Google for Developers | CloudRaven Enrichment
...
- Method: users.stop | Gmail | Google for Developers Skip to main content Workspace / English Deutsch Español Español – América Latina Français Indonesia Italiano Polski Português – Brasil Tiếng Việt Türkçe Русский עברית العربيّة فارسی हिंदी বাংলা ภาษาไทย 中文 – 简体 中文 – 繁體 日本語 한국어 Sign in Gmail Home Google Workspace Gmail Reference Send feedback Method: users.stop Stay organized with collections Save and categorize content based on your preferences.
- HTTP request Path parameters Request body Response body Authorization scopes Turn off push notification delivery for the given user mailbox.
- For more information, see Configure push notifications in Gmail API .
- HTTP request POST https://gmail.googleapis.com/gmail/v1/users/{userId}/stop The URL uses gRPC Transcoding syntax.
...
- Extracted page: `knowledgebase/store/extracted/google-identity-and-workspace/v1-users-stop-9717efa2c8.md`
- Raw source: `knowledgebase/store/raw_html/google-identity-and-workspace/v1-users-stop-9717efa2c8.html`
