---
title: Method: users.drafts.send | Gmail | Google for Developers | CloudRaven Enrichment
source_url: https://developers.google.com/workspace/gmail/api/reference/rest/v1/users.drafts/send
target_id: google-identity-and-workspace
dependency: Google Identity and Workspace Events
collected_at: 2026-04-16T03:21:22.732412+00:00
kind: enriched-doc
tags: google, auth, gmail, calendar, webhooks, notifications
---

# Method: users.drafts.send | Gmail | Google for Developers | CloudRaven Enrichment
...
- Extracted page: `knowledgebase/store/extracted/google-identity-and-workspace/v1-users-drafts-send-db35bb8bff.md`
- Raw source: `knowledgebase/store/raw_html/google-identity-and-workspace/v1-users-drafts-send-db35bb8bff.html`
