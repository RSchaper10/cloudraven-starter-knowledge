---
title: Method: users.labels.get | Gmail | Google for Developers | CloudRaven Enrichment
source_url: https://developers.google.com/workspace/gmail/api/reference/rest/v1/users.labels/get
target_id: google-identity-and-workspace
dependency: Google Identity and Workspace Events
collected_at: 2026-04-16T03:21:17.763541+00:00
kind: enriched-doc
tags: google, auth, gmail, calendar, webhooks, notifications
---

# Method: users.labels.get | Gmail | Google for Developers | CloudRaven Enrichment
...
- HTTP request GET https://gmail.googleapis.com/gmail/v1/users/{userId}/labels/{id} The URL uses gRPC Transcoding syntax.
...
- Extracted page: `knowledgebase/store/extracted/google-identity-and-workspace/v1-users-labels-get-37f0556bcc.md`
- Raw source: `knowledgebase/store/raw_html/google-identity-and-workspace/v1-users-labels-get-37f0556bcc.html`
