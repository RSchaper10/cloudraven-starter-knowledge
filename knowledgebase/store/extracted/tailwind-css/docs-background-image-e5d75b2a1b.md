...
- 2026-04-16T03:22:04.699241+00:00
...
- --> </ div > This is just a shorthand for bg-linear -[ var( <custom-property> )] that adds the var() function for you automatically.
...
to add a linear gradient to an element:
...
to add a radial gradient to an element:
...
to add a conic gradient to an element:
...
from-blue-600 to-sky-400 to-50%"
...
from-indigo-600 via-indigo-50 to-indigo-600"
...
from-violet-700 via-lime-300 to-violet-700"
...
By default gradients are interpolated in the
