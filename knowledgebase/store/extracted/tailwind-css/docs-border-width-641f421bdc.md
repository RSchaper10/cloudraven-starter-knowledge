...
collected_at: 2026-04-16T03:22:06.929037+00:00
kind: extracted-doc
---
...
- 2026-04-16T03:22:06.929037+00:00
...
& > :not(:last-child) { border-inline-start-width: 0px; border-inline-end-width:
...
& > :not(:last-child) { border-inline-start-width: 0px; border-inline-end-width: var(
...
& > :not(:last-child) { border-top-width: 0px; border-bottom-width:
...
& > :not(:last-child) { border-top-width: 0px; border-bottom-width: var(
...
to set the border width for all sides of an element:
...
to set the border width for one side of an element:
...
to set the border width on two sides of an element at the same time:
...
logical properties, which map to either the top or bottom border based on the writing mode:
...
to add borders between child elements:
