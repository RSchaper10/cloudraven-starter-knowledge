---
title: KeyframeTrack - Three.js Docs
source_url: https://threejs.org/docs/pages/KeyframeTrack.html
target_id: three-js
dependency: Three.js
collected_at: 2026-04-16T03:23:26.637519+00:00
kind: extracted-doc
---
...
- 2026-04-16T03:23:26.637519+00:00

Direct links in scope:

- https://threejs.org/docs/pages/KeyframeTrack.html
- https://threejs.org/docs/pages/global.html
- https://threejs.org/docs/pages/BezierInterpolant.html
- https://threejs.org/docs/pages/DiscreteInterpolant.html
- https://threejs.org/docs/pages/LinearInterpolant.html
- https://threejs.org/docs/pages/CubicInterpolant.html

Captured summary:

- KeyframeTrack - Three.js Docs KeyframeTrack Constructor new KeyframeTrack ( name : string , times : Array.<number> , values : Array.<(number|string|boolean)> , interpolation : InterpolateLinear | InterpolateDiscrete | InterpolateSmooth | InterpolateBezier ) Constructs a new keyframe track.
...
The Bezier interpolant requires tangent data to be set via the

settings

property on the track before creating the interpolant. The settings should contain:

inTangents

: Float32Array with [time, value] pairs per keyframe per component
...
Performs minimal validation on the keyframe track. Returns
