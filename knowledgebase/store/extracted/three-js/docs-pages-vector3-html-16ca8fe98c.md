---
title: Vector3 - Three.js Docs
source_url: https://threejs.org/docs/pages/Vector3.html
target_id: three-js
dependency: Three.js
collected_at: 2026-04-16T03:23:31.103017+00:00
kind: extracted-doc
---
...
- 2026-04-16T03:23:31.103017+00:00
...
- https://threejs.org/docs/pages/Cylindrical.html
- https://threejs.org/docs/pages/Spherical.html

Captured summary:

- Vector3 - Three.js Docs Vector3 Constructor new Vector3 ( x : number , y : number , z : number ) Constructs a new 3D vector.
- isVector3 : boolean (readonly) This flag can be used for type testing.
...
Sets this vector's x value to be
...
The interpolation factor, typically in the closed interval
...
Converts this vector to a unit vector - that is, sets it equal to a vector with the same direction as this one, but with a vector length of
...
Sets each component of this vector to a pseudo-random value between
