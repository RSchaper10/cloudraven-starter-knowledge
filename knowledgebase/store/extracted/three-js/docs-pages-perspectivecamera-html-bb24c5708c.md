---
title: PerspectiveCamera - Three.js Docs
source_url: https://threejs.org/docs/pages/PerspectiveCamera.html
target_id: three-js
dependency: Three.js
collected_at: 2026-04-16T03:23:41.413513+00:00
kind: extracted-doc
---
...
- 2026-04-16T03:23:41.413513+00:00
...
- https://threejs.org/docs/pages/PerspectiveCamera.html
- https://threejs.org/docs/pages/StereoCamera.html
- https://threejs.org/docs/pages/OrthographicCamera.html
- https://threejs.org/docs/pages/Vector2.html

Captured summary:

- PerspectiveCamera - Three.js Docs EventDispatcher → Object3D → Camera → PerspectiveCamera Constructor new PerspectiveCamera ( fov : number , aspect : number , near : number , far : number ) Constructs a new perspective camera.
- aspect : number The aspect ratio, usually the canvas width / canvas height.
- Must be greater than the current value of PerspectiveCamera#near .
- filmGauge : number Film size used for the larger axis.
- This parameter does not influence the projection matrix unless PerspectiveCamera#filmOffset is set to a nonzero value.
...
Film size used for the larger axis. Default is

35

(millimeters). This parameter does not influence the projection matrix unless
...
Object distance used for stereoscopy and depth-of-field effects. This parameter does not influence the projection matrix unless a
...
The camera's near plane. The valid range is greater than

0

and less than the current value of
...
a valid value for a perspective camera's near plane.
...
Returns the height of the image on the film. If

PerspectiveCamera#aspect

is greater than or equal to one (landscape format), the result equals
...
Returns the width of the image on the film. If
...
Computes the 2D bounds of the camera's viewable rectangle at a given distance along the viewing direction. Sets
...
to the coordinates of the lower-left and upper-right corners of the view rectangle.
