---
title: Plane - Three.js Docs
source_url: https://threejs.org/docs/pages/Plane.html
target_id: three-js
dependency: Three.js
collected_at: 2026-04-16T03:23:23.590237+00:00
kind: extracted-doc
---
...
- 2026-04-16T03:23:23.590237+00:00
...
- Plane - Three.js Docs Plane Constructor new Plane ( normal : Vector3 , constant : number ) Constructs a new plane.
...
if this plane is equal with the given one.
...
if the given bounding box intersects with the plane.
...
if the given line segment intersects with (passes through) the plane.
...
if the given bounding sphere intersects with the plane.
...
Sets the plane components by defining
