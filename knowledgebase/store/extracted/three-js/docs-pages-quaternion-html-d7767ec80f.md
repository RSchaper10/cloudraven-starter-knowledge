...
source_url: https://threejs.org/docs/pages/Quaternion.html
target_id: three-js
dependency: Three.js
collected_at: 2026-04-16T03:23:31.507197+00:00
kind: extracted-doc
---
...
- 2026-04-16T03:23:31.507197+00:00
...
- Quaternion - Three.js Docs Quaternion Constructor new Quaternion ( x : number , y : number , z : number , w : number ) Constructs a new quaternion.
...
Computes the squared Euclidean length (straight-line length) of this quaternion, considered as a 4 dimensional vector. This can be useful if you are comparing the lengths of two quaternions, as this is a slightly more efficient calculation than
...
Normalizes this quaternion - that is, calculated the quaternion that performs the same rotation as this one, but has a length equal to
...
Rotates this quaternion by a given angular step to the given quaternion. The method ensures that the final quaternion will not overshoot
...
The interpolation factor. A value in the range

[0,1]

will interpolate. A value outside the range
...
This methods defines the serialization result of this class. Returns the numerical elements of this quaternion in an array of format
