---
title: NodeBuilder - Three.js Docs
source_url: https://threejs.org/docs/pages/NodeBuilder.html
target_id: three-js
dependency: Three.js
collected_at: 2026-04-16T03:23:40.260159+00:00
kind: extracted-doc
---

# NodeBuilder - Three.js Docs
...
- 2026-04-16T03:23:40.260159+00:00
...
- https://threejs.org/docs/pages/NodeParser.html
- https://threejs.org/docs/pages/StackNode.html
- https://threejs.org/docs/pages/NodeAttribute.html
- https://threejs.org/docs/pages/AttributeNode.html
- https://threejs.org/docs/pages/BindGroup.html
- https://threejs.org/docs/pages/BufferAttributeNode.html
- https://threejs.org/docs/pages/NodeCache.html
- https://threejs.org/docs/pages/Camera.html
- https://threejs.org/docs/pages/Node.html
- https://threejs.org/docs/pages/ClippingContext.html
- https://threejs.org/docs/pages/NodeCode.html
- https://threejs.org/docs/pages/FunctionNode.html
...
- https://threejs.org/docs/pages/NodeMaterialObserver.html
- https://threejs.org/docs/pages/Scene.html

Captured summary:

- NodeBuilder - Three.js Docs NodeBuilder Constructor new NodeBuilder ( object : Object3D , renderer : Renderer , parser : NodeParser ) Constructs a new node builder.
...
This array holds the node attributes of this builder created via
...
Current code flow. All code generated in this stack will be stored in
...
might be temporarily overwritten by other caches, this member retains the reference to the builder's own cache.
...
Returns the native shader operator name for a given generic name. It is a similar type of method like

NodeBuilder#getMethod
...
For a given type this method changes the component type to the given value. E.g.

vec4

should be changed to the new component type
...
with the given dimensions and options.
...
have the ability to compute code in vertex-stage and return the value in fragment-stage even if it is being executed in an input fragment.
...
The code flow or node.build() result.
...
Formats the given shader snippet from a given type into another one. E.g. this method might be used to convert a simple float string
...
for the given buffer attribute node.
...
The closest sub-build name or null if none found.
...
Returns the drawIndex input variable as a native shader string. Only relevant for WebGL and its
...
Returns the native shader method name for a given generic name. E.g. the method name

textureDimensions

matches the WGSL name but must be resolved to
...
Returns a node for the given hash, see

NodeBuilder#setHashNode
...
The struct type or null if not found.
...
Returns the native snippet for a ternary operation. E.g. GLSL would output a ternary op as

cond ? x : y

whereas WGSL would output it as
...
The maximum number of bytes available for uniform buffers.
...
Returns whether a Node or its flow is deterministic, useful for use in
...
Whether to flip texture data along its vertical axis or not. WebGL needs this method evaluate to
...
if data from the previous frame are required. Relevant when computing motion vectors with
...
Whether data from the previous frame are required or not.
...
Sorts the bind groups and updates

NodeBuilder#bindingsIndexes
