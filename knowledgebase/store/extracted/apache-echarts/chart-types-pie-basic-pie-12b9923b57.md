---
title: Basic Pie - Pie - Common Charts - How To Guides - Handbook - Apache ECharts
source_url: https://echarts.apache.org/handbook/en/how-to/chart-types/pie/basic-pie
target_id: apache-echarts
dependency: Apache ECharts
collected_at: 2026-04-16T03:22:59.821135+00:00
kind: extracted-doc
---

# Basic Pie - Pie - Common Charts - How To Guides - Handbook - Apache ECharts
...
- 2026-04-16T03:22:59.821135+00:00
...
The radius of pie chart can be defined by
...
) and absolute pixel string(

'200'

) are available. While it is a percent string, it is proportional related to the shorter container(
...
By default, if the data sum is 0, the series will divide the shape equally. For instance, if you don't want to show any shape while all 4 series have value equals 0, you could define
...
If you are willing to hide the label as well, define the
