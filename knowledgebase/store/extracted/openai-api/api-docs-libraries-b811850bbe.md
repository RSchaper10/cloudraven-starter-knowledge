...
- 2026-04-15T19:44:24.282751+00:00
...
Use the official OpenAI libraries above for direct API requests. Use the OpenAI Agents SDK when your application needs code-first orchestration for agents, tools, handoffs, guardrails, tracing, or sandbox execution.
...
The libraries below are built and maintained by the broader developer community. You can also

watch our OpenAPI specification

repository on GitHub to get timely updates on when we make changes to our API.
